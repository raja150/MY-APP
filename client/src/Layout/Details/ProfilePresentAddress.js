...
function ProfilePresentAddress(props) {
    ...
    const handleSave = async (values, actions) => {
        ...
        await UpdateProfileService.UpdatePresentAddress(data).then((response) => {
            props.setPresentResult('presentAddress', response.data);
            props.toggle();
        }).catch((err) => {
                        ...
                        {({ values, errors, touched, setFieldValue, isSubmitting }) => {
                            ...
                            return (
                                state.isLoading ? <Loading /> :
                                    <Form>
                                        <ModalBody>
                                            <ModalHeader> Present Address  </ModalHeader>
                                            <Row>
                                                <Col xs='6'>
                                                    <Input
                                                        {...{
...
export default ProfilePresentAddress
