...
export default function ApproveWFH(props) {
    ...
    const handleSubmit = async (data, actions) => {
        ...
        await WorkFromHomeService.approveAproveOrReject(data).then((res) => {
            ...
            formUtil.displayAPIError(error)
        });
    }
