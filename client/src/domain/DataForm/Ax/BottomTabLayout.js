                    ...
                    compare.isEqual(refEntityId, '') ? <AxWizard  {...{
                        ...
                        <ReactCSSTransitionGroup
                            ...
                            <div className="app-page-title pt-2 pb-2">
                                <div className="page-title-wrapper">
                                    <div className="page-title-heading">
                                        <Breadcrumb>
                                            <div style={{ fontSize: '30px' }} className={entityData.entityJSON.icon} />
                                            <BreadcrumbItem> {entityData.entityJSON.module} </BreadcrumbItem>
                                            <BreadcrumbItem>
                                                {/* <Link to={`/d/list/${fid}`}> */}
                                                {entityData.entityJSON.displayName}
                                                {/* </Link> */}
                                            </BreadcrumbItem>
                                            <BreadcrumbItem>
                                                {eid ? "Update" : "New"}
                            ...
                            <AxWizard  {...{
                                ...
                                tabJson: entityData.entityJSON.tabs[0], module: entityData.module,
                                icon: entityData.entityJSON.icon, ...props
                            }} handleFromSaved={handleFromSaved} />
                                        ...
                                        return (() => {
                                            return key > 0 ?
                                                compare.isEqual(key, 0) ?
                                                    //Both reference entity id and edit entity id both are same for primary tab
                                                    <TabPane tab={tab.displayName} key={key} placeholder="loading..." className='mt-2'>

                                                        <AxWizard  {...{
                                                            refEntityId: refEntityId, editEntityId: refEntityId,
                                                            tabJson: tab, module: entityData.module,
                                                            icon: entityData.entityJSON.icon, ...props
                                                        }} handleFromSaved={handleFromSaved} />
                                                    </TabPane>
