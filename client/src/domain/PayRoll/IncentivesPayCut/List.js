...
const title = 'Incentives Pay Cut'
const fields = [
    ...
    { name: 'year', label: 'Pay Month-Year', type: 'input' },
    { name: 'incentives', label: 'Incentives', type: 'number' },
    { name: 'payCut', label: 'Pay Cut', type: 'number' },

]
function IncentivesPayCutList(props) {
    const searchCard = () => {
        return (
            <Card className='mb-1'>
                <CardBody>
...
export default UpdateTable(IncentivesPayCutList, { ...IncentivesPayCutService.paginate() }, fields, '', title, '', '')