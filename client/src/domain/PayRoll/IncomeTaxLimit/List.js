...
const fields = [
    ...
    { name: 'year', label: 'Pay Month', type: 'input' },
    { name: 'amount', label: 'Amount', type: 'int' },


]
function IncomeTaxLimitList(props) {
    const searchCard = () => {
        return (
            <Card className='mb-1'>
                <CardBody>
...
export default UpdateTable(IncomeTaxLimitList, { ...IncomeTaxLimitService.paginate() }, fields, '', title, '', '')