...
export const MyTeamAttendance = {
    ...
    "filters": [
        ...
        },
        {
            ...
            "field": "Dropdown",
            // "url": 'LM_Attendance/Attendance/GetList',
            "type": "int",
    ...
    "columns": [
        ...
        {
            "name": 'attendanceStatus',//formUtil.GetTextFromArray(ATTENDANCE_STATUS, "attendanceStatus")
            "label": "Attendance Status",
            "type": "string",
            "data": ATTENDANCE_STATUS,
            "orderBy": 7,
