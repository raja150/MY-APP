import { ATTENDANCE_STATUS,att } from "Site_constants";
export const SelfAttendance = {
    "id": "834ed77e-73ab-4fe4-9c74-f7181fa336e6",
    "name": "MyTeamAttendance",
    "label": "MyTeamAttendance",
    "url": 'LMSReport/SelfAttendance',
    "summaryTableUrl": 'LM_Attendance/Attendance/EmployeeSummary',
    "type": 1,
    "orderBy": 0,
    "filters": [
        {
    ...
    "columns": [
        ...
        {
            "name": 'attendanceStatus',//status
            "label": "Attendance Status",
            "type": "string",
            "data": ATTENDANCE_STATUS,//att
            "orderBy": 6,
            "status": true
        },
    ],
