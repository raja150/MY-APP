...
namespace TranSmart.API.Extensions.DI
{
    ...
    public static class AutoRegisterHelpers
    {
		...
		public static void RegisterManagedServices(this IServiceCollection services)
		{
			services.AddScoped<IManageService, ManageService>();

			_ = services.AddScoped<EmployeeManageService>()
			   .AddScoped<IManageService, EmployeeManageService>(s => s.GetService<EmployeeManageService>());

			_ = services.AddScoped<DepartmentGroupManageService>()
		   .AddScoped<IManageService, DepartmentGroupManageService>(s => s.GetService<DepartmentGroupManageService>());

			_ = services.AddScoped<IServiceFactory, ServiceFactory>();
		}
	}
}
