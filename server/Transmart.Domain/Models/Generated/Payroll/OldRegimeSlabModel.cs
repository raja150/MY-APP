...
{
    public partial class OldRegimeSlabModel : BaseModel
    {
    ...
    public class OldRegimeSlabModelValidator : AbstractValidator<OldRegimeSlabModel>
    {
        public OldRegimeSlabModelValidator()
        {
            ...
            RuleFor(c => c.TaxRate).LessThanOrEqualTo(99).WithName("Tax Rate");
        }
    }
}
